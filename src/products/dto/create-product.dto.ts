...
export class CreateProductDto {
  @ApiProperty({ description: 'The name of the product', example: 'Gold Tarot Card Deck' })
  @IsString()
  @IsNotEmpty()
  productName: string;
  ...
  @ApiProperty({ description: 'A short feature highlight of the product', example: 'Handmade, Premium Gold Foil' })
  @IsString()
  @IsNotEmpty()
  feature: string;

  @ApiProperty({ description: 'The detailed description of the product', example: 'A complete 78-card deck with gorgeous gold foil details and an instructional booklet.' })
  @IsString()
  @IsNotEmpty()
  description: string;
  ...
  @ApiProperty({ description: 'The type category of the product', enum: ProductType, example: ProductType.CARD })
  @IsEnum(ProductType, {
